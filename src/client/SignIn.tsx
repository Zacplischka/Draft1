        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm">
          ...
          {devAuth ? (
            ...
            >
              ...
              />
              <button className="w-full rounded-lg border border-indigo-600 px-4 py-2.5 font-medium text-indigo-600 hover:bg-indigo-50">
            ...
            <button
              ...
              className="mt-6 w-full rounded-lg border border-indigo-600 px-4 py-2.5 font-medium text-indigo-600 hover:bg-indigo-50"
            >
